...
const HirePage: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen ${theme === 'dark' ? 'bg-slate-900' : 'bg-white'}`}>
      ...
      {/* Why Hire Section */}
      <section className={`py-20 ${theme === 'dark' ? 'bg-gradient-to-b from-slate-800 to-slate-900' : 'bg-gradient-to-b from-blue-50/50 to-white'}`}>
        <div className="container mx-auto px-4">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <p className={`text-xl max-w-3xl mx-auto ${
              ...
              Hear from our hiring partners who've found exceptional talent through us
            </p>
          </motion.div>
      ...
      <section className={`py-20 ${theme === 'dark' ? 'bg-slate-900' : 'bg-white'}`}>
        <div className="container mx-auto px-4">
          ...
          >
            ...
            >
              <span className={`px-6 py-2 rounded-full text-sm font-semibold backdrop-blur-sm ${
                theme === 'dark' 
                  ? 'bg-gradient-to-r from-pink-900/30 to-red-900/30 text-pink-400 border border-pink-800/50'
                  : 'bg-gradient-to-r from-pink-50 to-red-50 text-pink-700 border border-pink-200/50'
              }`}>
            ...
            <h2 className={`text-4xl md:text-5xl lg:text-6xl font-black mb-6 ${
              ...
              What <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-red-500 to-orange-500">Industry Leaders</span> Say
            </h2>
            
            <p className={`text-xl md:text-2xl max-w-4xl mx-auto mb-12 ${
              theme === 'dark' ? 'text-slate-300' : 'text-slate-700'
            }`}>
              Hear from <span className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 to-red-500">HR professionals</span> and 
              <span className="font-bold text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-500"> engineering managers</span> who have successfully hired our graduates
            </p>
            ...
            >
              <div className={`text-center p-6 rounded-2xl ${
                theme === 'dark' 
                  ? 'bg-slate-800/50 border border-slate-700' 
                  : 'bg-gradient-to-br from-pink-50 to-red-50 border border-pink-200'
              } backdrop-blur-sm`}>
              ...
              <div className={`text-center p-6 rounded-2xl ${
                theme === 'dark' 
                  ? 'bg-slate-800/50 border border-slate-700' 
                  : 'bg-gradient-to-br from-yellow-50 to-green-50 border border-yellow-200'
              } backdrop-blur-sm`}>
                <div className={`text-3xl font-black mb-2 ${
          ...
          >
            ...
            >
              <a
                href="#hiring-form"
                className="inline-flex items-center gap-3 px-10 py-5 bg-gradient-to-r from-pink-600 via-red-600 to-orange-600 text-white font-bold rounded-2xl shadow-2xl hover:shadow-pink-500/25 transition-all duration-500 overflow-hidden relative group text-lg"
              >
                <motion.div
                  animate={{ 
                    rotate: [0, 10, -10, 0],
                ...
                {/* Enhanced background effects */}
                <motion.div 
                  className="absolute inset-0 bg-gradient-to-r from-pink-700 via-red-700 to-orange-700 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
                  whileHover={{
                    background: [
                      "linear-gradient(90deg, rgba(219, 39, 119, 1) 0%, rgba(220, 38, 38, 1) 50%, rgba(234, 88, 12, 1) 100%)",
                      "linear-gradient(90deg, rgba(236, 72, 153, 1) 0%, rgba(239, 68, 68, 1) 50%, rgba(249, 115, 22, 1) 100%)",
                      "linear-gradient(90deg, rgba(219, 39, 119, 1) 0%, rgba(220, 38, 38, 1) 50%, rgba(234, 88, 12, 1) 100%)"
                    ]
                  }}
                  transition={{ duration: 2, repeat: Infinity }}
      ...
      {/* Enhanced Contact Form Section - Moved up after hero */}
