...
// Add custom CSS for 3D flip cards
...
if (typeof document !== 'undefined') {
  ...
  if (!document.head.querySelector('style[data-flip-cards]')) {
    styleElement.setAttribute('data-flip-cards', 'true');
...
const ResponsiveSlider: React.FC<ResponsiveSliderProps> = ({
  ...
  const maxIndex = Math.max(0, items.length - getCurrentItemsPerView());
  ...
  useEffect(() => {
    if (!isAutoplay || isPaused || items.length <= getCurrentItemsPerView()) return;
  ...
  }, [isAutoplay, isPaused, autoplayDelay, nextSlide, items.length, getCurrentItemsPerView]);
  ...
  const itemsPerViewCount = getCurrentItemsPerView();
  const itemWidth = 100 / itemsPerViewCount;
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      >
        <motion.div
          ...
          style={{
            ...
            width: `${(items.length * 100) / itemsPerViewCount}%`
          }}
        >
      ...
      {showDots && items.length > itemsPerViewCount && (
      ...
      {showArrows && items.length > itemsPerViewCount && (
        <>
          <button
            ...
            } shadow-lg transition-all duration-300 hover:scale-110 z-10`}
          >
...
const AboutPage: React.FC = () => {
  ...
  // Core team data - Top 3 key members
  const teamMembers = [
    {
    ...
    <div className={`min-h-screen ${theme === 'dark' ? 'bg-slate-900' : 'bg-white'}`}>
              ...
              >
                <Link 
                  ...
                  className={`group px-8 py-4 rounded-xl font-bold border-2 backdrop-blur-md transition-all duration-500 text-base relative overflow-hidden flex items-center gap-2 ${
                    theme === 'dark'
                      ? 'border-emerald-500/50 text-emerald-400 hover:bg-emerald-900/30 hover:border-emerald-400 shadow-lg shadow-emerald-900/10'
                      : 'border-emerald-600/50 text-emerald-700 hover:bg-emerald-100/50 hover:border-emerald-600 shadow-lg shadow-emerald-200/10'
                  }`}
                >
                  ...
                  <motion.div
                    className={`absolute inset-0 ${
                      theme === 'dark' ? 'bg-emerald-900/15' : 'bg-emerald-100/20'
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-6 mb-8">
                    <motion.div 
                      ...
                      className="w-16 h-16 rounded-2xl bg-gradient-to-r from-blue-500 to-cyan-500 flex items-center justify-center text-white text-2xl font-bold shadow-xl"
                    >
                      🎯
                    </motion.div>
                    <div>
              ...
              <div className={`relative p-6 md:p-8 rounded-2xl overflow-hidden ${
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-6 mb-8">
                    <motion.div 
                      whileHover={{ scale: 1.1, rotate: -10 }}
                      className="w-16 h-16 rounded-2xl bg-gradient-to-r from-purple-500 to-pink-500 flex items-center justify-center text-white text-2xl font-bold shadow-xl"
                    >
                      🔮
                    </motion.div>
                    <div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          <ResponsiveGridSlider
            ...
            renderItem={(value, index) => (
              ...
              >
                <div className={`relative p-6 md:p-8 rounded-2xl overflow-hidden h-full min-h-[320px] flex flex-col ${
                  theme === 'dark'
                    ? 'bg-gradient-to-br from-slate-800/80 to-slate-900/80 border border-slate-700/50'
                  ...
                  <div className="relative z-10 flex flex-col h-full">
                    ...
                    <div className="flex flex-col items-center text-center mb-6">
                      <motion.div 
                        ...
                        className={`w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-gradient-to-r ${value.color} flex items-center justify-center text-white text-xl md:text-2xl shadow-xl mb-4 group-hover:shadow-2xl transition-shadow duration-300`}
                      >
                        {value.icon}
                      </motion.div>
      ...
      <section className={`py-20 ${theme === 'dark' ? 'bg-slate-800/30' : 'bg-blue-50/50'}`}>
        <div className="container mx-auto px-4">
          ...
          <TeamFlipCards team={teamMembers} theme={theme} />
        </div>
      </section>
          ...
          <ResponsiveGridSlider
            ...
            renderItem={(category, index) => (
              <motion.div
                ...
                className="group h-full"
              >
                <div className={`relative p-6 md:p-8 rounded-2xl overflow-hidden h-full min-h-[340px] flex flex-col ${
                  theme === 'dark'
                    ? 'bg-gradient-to-br from-slate-800/80 to-slate-900/80 border border-slate-700/50'
                    : 'bg-gradient-to-br from-white/80 to-slate-50/80 border border-slate-200/50'
                } backdrop-blur-xl shadow-2xl hover:shadow-3xl transition-all duration-500 group-hover:scale-[1.02] group-hover:-translate-y-2`}>
                  ...
                  <div className="relative z-10 flex flex-col h-full">
                    ...
                    <div className="flex flex-col items-center text-center mb-8">
                      <motion.div 
                        ...
                        transition={{ duration: 0.3 }}
                        className={`w-14 h-14 md:w-16 md:h-16 rounded-2xl bg-gradient-to-r ${category.color} flex items-center justify-center text-white text-xl md:text-2xl shadow-xl mb-4 group-hover:shadow-2xl transition-shadow duration-300`}
                      >
                        {category.icon}
                      </motion.div>
              ...
              >
                <div className={`relative p-8 md:p-10 rounded-3xl overflow-hidden h-full min-h-[400px] flex flex-col ${
                  ...
                  <div className="relative z-10 flex flex-col h-full text-center">
                    ...
                    >
                      <div className={`w-20 h-20 md:w-24 md:h-24 rounded-2xl bg-gradient-to-r ${stat.color} flex items-center justify-center text-white text-3xl md:text-4xl shadow-xl group-hover:shadow-2xl transition-shadow duration-300`}>
                        {stat.icon}
                      </div>
                    </motion.div>
                    ...
                    <motion.div 
                      className={`text-2xl md:text-3xl font-black mb-4 text-transparent bg-clip-text bg-gradient-to-r ${stat.color}`}
                      initial={{ scale: 0 }}
                      whileInView={{ scale: 1 }}
                      viewport={{ once: true }}
                      transition={{ 
              ...
              <div className={`relative p-10 rounded-3xl overflow-hidden ${
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-6 mb-8">
                    <motion.div 
                      whileHover={{ scale: 1.1, rotate: 10 }}
                      className="w-16 h-16 rounded-2xl bg-gradient-to-r from-emerald-500 to-blue-500 flex items-center justify-center text-white text-2xl font-bold shadow-xl"
                    >
                      🚀
                    </motion.div>
                    <div>
              ...
              <div className={`relative p-10 rounded-3xl overflow-hidden ${
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-6 mb-8">
                    <motion.div 
                      whileHover={{ scale: 1.1, rotate: -10 }}
                      className="w-16 h-16 rounded-2xl bg-gradient-to-r from-blue-500 to-purple-500 flex items-center justify-center text-white text-2xl font-bold shadow-xl"
                    >
                      ⭐
                    </motion.div>
                    <div>
          ...
          <div className="max-w-5xl mx-auto text-center">
            ...
            >
              ...
              >
                <Link 
                  to="/contact" 
                  className={`group relative px-10 py-5 rounded-2xl font-bold border-2 backdrop-blur-sm transition-all duration-500 text-lg overflow-hidden block ${
                    theme === 'dark'
                      ? 'border-emerald-500/60 text-emerald-400 hover:bg-emerald-900/30 hover:border-emerald-400 shadow-lg shadow-emerald-900/20'
                      : 'border-emerald-600/60 text-emerald-700 hover:bg-emerald-100/50 hover:border-emerald-600 shadow-lg shadow-emerald-200/20'
                  }`}
                >
                  <span className="relative z-10 flex items-center gap-3">
                    <motion.div
...
// Team Flip Cards Component - Simple 3-card grid with flip functionality
...
const TeamFlipCards: React.FC<TeamFlipCardsProps> = ({ team, theme }) => {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
      {team.map((member, index) => (
        ...
        >
          <div
            className={`relative w-full h-[500px] cursor-pointer transition-transform duration-700 transform-style-preserve-3d ${
          ...
          >
            ...
            <div className={`absolute inset-0 w-full h-full backface-hidden rounded-2xl overflow-hidden ${
              ...
              <div className="relative h-64 overflow-hidden">
                ...
                {/* Expert Badge */}
                <div className="absolute top-4 left-4 px-3 py-1.5 rounded-full bg-gradient-to-r from-orange-500 to-red-500 text-white text-sm font-bold shadow-lg">
                  Expert
                </div>

                {/* Flip Indicator */}
                <div className="absolute top-4 right-4 w-10 h-10 rounded-full bg-black/30 backdrop-blur-sm flex items-center justify-center text-white">
                  <motion.svg 
                    className="w-5 h-5" 
                    fill="none" 
                    viewBox="0 0 24 24" 
              ...
              {/* Content */}
              <div className="p-6 flex flex-col h-[236px]">
                <div className="text-center mb-4">
                  ...
                  <p className="text-lg font-semibold text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-red-500">
                    {member.role}
                  </p>
                  </div>
            ...
            <div className={`absolute inset-0 w-full h-full backface-hidden rotate-y-180 rounded-2xl overflow-hidden ${
              ...
              <div className="p-6 h-full flex flex-col">
                ...
                <div className="text-center mb-6">
                  ...
                  <p className="text-lg font-semibold text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-red-500 mb-4">
                    {member.role}
                  </p>
                ...
                {/* Description */}
                <p className={`text-sm leading-relaxed mb-6 text-center flex-grow flex items-center ${
                    theme === 'dark' ? 'text-slate-400' : 'text-slate-600'
                  }`}>
                  {member.description}
                </p>
