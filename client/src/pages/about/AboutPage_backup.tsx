        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <motion.div
              ...
              className="mb-8"
            >
              <p className={`text-base md:text-lg lg:text-xl font-light leading-relaxed max-w-4xl mx-auto ${
            ...
            >
              <ResponsiveSlider
                ...
                renderItem={(stat, index) => (
                  <motion.div
                    key={index}
                    className={`p-2 md:p-3 lg:p-4 rounded-xl backdrop-blur-md border h-full min-h-[100px] md:min-h-[120px] flex flex-col justify-center ${
                      theme === 'dark' 
                  ...
                  >
                                    <div className="text-base md:text-lg lg:text-xl mb-1 md:mb-2 text-center">{stat.icon}</div>
                <div className={`text-base md:text-lg lg:text-xl xl:text-2xl font-bold mb-1 text-center ${
