  ...
  const successStories = [
    {
      ...
      testimonial: 'OSOP transformed my programming journey completely. Dr. Bajpai Sir\'s teaching methodology made complex Java concepts crystal clear. The hands-on projects and interview preparation were instrumental in landing my position at Innoeye.',
      image: '/images/students/placements/Vasu-Tiwari-Innoeye.jpg',
      linkedIn: '#',
      achievement: 'Promoted to Senior Developer in 10 months',
      location: 'Indore'
    },
    {
      id: 2,
      ...
      duration: '8 months',
      skills: ['Java', 'Spring Framework', 'Microservices', 'Payment Systems'],
      testimonial: 'The hands-on approach at OSOP is incredible. I went from knowing nothing about programming to building enterprise payment applications. The weekly doubt sessions were extremely helpful for my growth.',
      image: '/images/students/placements/Tanwant-Singh-WorldPay.jpg',
      linkedIn: '#',
      achievement: 'Led payment gateway integration projects',
      location: 'Bangalore'
    },
    {
      id: 3,
      ...
      testimonial: 'OSOP\'s teaching methodology is outstanding. The instructors break down complex topics into simple, digestible parts. The practical projects gave me confidence to work on real applications.',
      image: '/images/students/placements/Shubham-Rathore.jpg',
      linkedIn: '#',
      achievement: 'Developed 3 major web applications in first year',
      location: 'Pune'
    },
    {
      id: 4,
      ...
      previousRole: 'Student',
      duration: '7 months',
      skills: ['Java', 'Spring Boot', 'REST APIs', 'E-commerce'],
      testimonial: 'The practical projects and coding exercises at OSOP gave me confidence to tackle any programming challenge. The placement support was exceptional and helped me join Hotwax.',
      image: '/images/students/placements/Shiva-Jain-Hotwax.jpg',
      linkedIn: '#',
      achievement: 'Built scalable e-commerce backend systems',
      location: 'Mumbai'
    },
    {
      id: 5,
      ...
      previousRole: 'Fresher',
      duration: '6 months',
      skills: ['Java', 'Spring Framework', 'Microservices', 'AWS'],
      testimonial: 'OSOP\'s industry-focused curriculum prepared me perfectly for the real world. Dr. Bajpai Sir\'s experience shows in every lecture. The mentorship was exceptional.',
      image: '/images/students/placements/Shailendra-MishraNew-Con-infosystems (1).jpg',
      linkedIn: '#',
      achievement: 'Architected enterprise solutions for clients',
      location: 'Hyderabad'
    },
    {
      id: 6,
      ...
      testimonial: 'The supportive learning environment at OSOP made all the difference. I could ask questions freely and get detailed explanations. The recorded sessions helped me revise concepts thoroughly.',
      image: '/images/students/placements/Ruchika-Khandelwal-Innoeye.jpg',
      linkedIn: '#',
      achievement: 'Developed full-stack applications serving 50K+ users',
      location: 'Chennai'
    },
    {
      id: 7,
      ...
      duration: '6 months',
      skills: ['React', 'Node.js', 'MongoDB', 'Express'],
      testimonial: 'The comprehensive full-stack course at OSOP was amazing. The hands-on projects and real-world applications helped me secure my position at Firstlogic.',
      image: '/images/students/placements/Prachi-Bundela-Fitstlogic.jpg',
      linkedIn: '#',
      achievement: 'Built end-to-end web applications for clients',
      location: 'Indore'
    },
    {
      id: 8,
      ...
      testimonial: 'OSOP\'s practical approach to teaching Java enterprise development was exceptional. The industry-focused curriculum prepared me perfectly for my role at Systemetrix.',
      image: '/images/students/placements/Nitesh-Choyal-systemetrix.jpg',
      linkedIn: '#',
      achievement: 'Developed enterprise-grade applications',
      location: 'Bangalore'
    },
    {
      id: 9,
      ...
      previousRole: 'Fresher',
      duration: '5 months',
      skills: ['Java', 'Spring Framework', 'E-commerce', 'Database'],
      testimonial: 'Dr. Bajpai Sir\'s teaching methodology made complex Java concepts easy to understand. The practical projects and mentorship helped me join Hotwax successfully.',
      image: '/images/students/placements/Nilesh-Goyal-Hotwax.jpg',
      linkedIn: '#',
      achievement: 'Contributed to major e-commerce platform development',
      location: 'Mumbai'
    },
    {
      id: 10,
      ...
      testimonial: 'The comprehensive Java course at OSOP covered everything from basics to advanced enterprise development. The placement support was outstanding.',
      image: '/images/students/placements/Niket-Thada-Hotwax.jpg',
      linkedIn: '#',
      achievement: 'Built scalable microservices architecture',
      location: 'Pune'
    },
    {
      id: 11,
      ...
      duration: '7 months',
      skills: ['React', 'Node.js', 'MongoDB', 'Express'],
      testimonial: 'The full-stack development course at OSOP was comprehensive and industry-relevant. The combination of backend and frontend skills made me a versatile developer ready for Synechron.',
      image: '/images/students/placements/Neha-Parsai-Synechrone (1).jpg',
      linkedIn: '#',
      achievement: 'Built end-to-end financial applications',
      location: 'Mumbai'
    },
    {
      id: 12,
      ...
      testimonial: 'The Java enterprise program at OSOP was exceptional. Dr. Bajpai Sir\'s teaching methodology and hands-on projects prepared me perfectly for enterprise development.',
      image: '/images/students/placements/Manish-Singh-New-Con-infosystems.jpg',
      linkedIn: '#',
      achievement: 'Architected scalable enterprise solutions',
      location: 'Bangalore'
    },
    {
      id: 13,
      ...
      testimonial: 'The full-stack course at OSOP prepared me for real-world development. The focus on practical projects and industry best practices made me job-ready from day one.',
      image: '/images/students/placements/Manali-Jain-Diaspark (1).jpg',
      linkedIn: '#',
      achievement: 'Developed responsive web applications for clients',
      location: 'Pune'
    },
    {
      id: 14,
      ...
      previousRole: 'Student',
      duration: '5 months',
      skills: ['Java', 'Spring Framework', 'REST APIs', 'Database'],
      testimonial: 'The Java programming course was perfectly structured. From basic concepts to advanced frameworks, everything was taught with practical examples and real projects.',
      image: '/images/students/placements/Lokesh-Sharma-infobeans (1).jpg',
      linkedIn: '#',
      achievement: 'Built robust backend systems for enterprise clients',
      location: 'Indore'
    },
    {
      id: 15,
      name: 'Lkshyajeet Singh',
      course: 'Java Development',
      ...
      testimonial: 'The Java development course at OSOP opened up amazing opportunities. The comprehensive curriculum and excellent mentorship helped me secure my position at Yash Technology.',
      image: '/images/students/placements/Lkshyajeet-Singh-Yash-technology.jpg',
      linkedIn: '#',
      achievement: 'Developed cloud-native applications',
      location: 'Hyderabad'
    },
    {
      id: 16,
      ...
      duration: '6 months',
      skills: ['React', 'Node.js', 'MongoDB', 'Express'],
      testimonial: 'The full-stack development course was cutting-edge and practical. The comprehensive curriculum and hands-on projects helped me secure my position at Firstlogic.',
      image: '/images/students/placements/Krishna-Patel-Firstlogic.jpg',
      linkedIn: '#',
      achievement: 'Built scalable web applications for business clients',
      location: 'Mumbai'
    },
    {
      id: 17,
      ...
      previousRole: 'Fresher',
      duration: '5 months',
      skills: ['Java', 'Spring Boot', 'REST APIs', 'Database'],
      testimonial: 'The Java course at OSOP was comprehensive and industry-aligned. Dr. Bajpai Sir\'s teaching methodology made complex concepts easy to understand and implement.',
      image: '/images/students/placements/IndraJeet-Singh-Infobeans.jpg',
      linkedIn: '#',
      achievement: 'Developed enterprise Java applications',
      location: 'Indore'
    },
    {
      id: 18,
      ...
      duration: '7 months',
      skills: ['React', 'Node.js', 'JavaScript', 'MongoDB'],
      testimonial: 'The full-stack development course was thorough and practical. Learning modern web technologies and frameworks prepared me perfectly for my role at Diaspark.',
      image: '/images/students/placements/Hemant-Jhanwar-Diaspark.jpg',
      linkedIn: '#',
      achievement: 'Built responsive web applications for diverse clients',
      location: 'Bangalore'
    },
    {
      id: 19,
      ...
      previousRole: 'Fresher',
      duration: '6 months',
      skills: ['Java', 'Spring Framework', 'Microservices', 'REST APIs'],
      testimonial: 'The Java enterprise course provided comprehensive knowledge of enterprise development. The practical approach with real projects made me industry-ready for New Con.',
      image: '/images/students/placements/Hardik-Jain-New-Con.jpg',
      linkedIn: '#',
      achievement: 'Architected scalable enterprise solutions',
      location: 'Hyderabad'
    },
    {
      ...
      testimonial: 'The full-stack program was intensive and comprehensive. From frontend to backend development, the course covered all aspects of modern web development perfectly.',
      image: '/images/students/placements/Ekta-Sharma--Synechrome.jpg',
      linkedIn: '#',
      achievement: 'Developed end-to-end financial applications',
      location: 'Mumbai'
    }
  ];
